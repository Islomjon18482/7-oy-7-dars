...
function App() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="items">
        <div droppable  onDrop={(e) => handleDrop(e,"todo")} onDragOver={handleDragOver} className="toDo">
          ...
          <div className="list__wrapper">
            {toDo
              ? toDo.map((el, index) => {
                  return (
                    <div key={index} draggable onDragStart={(e) => heandleDragStart(e, el)} className="list">
                      <p>{el.text}</p>
        ...
        <div droppable  onDrop={(e) => handleDrop(e, "doing")} onDragOver={handleDragOver} className="doing">
          <div className="default">
            <h3>IN PROGRESS</h3>
            <div className="inp__btn">
              <input ref={doingRef} type="text" placeholder="Enter doing work..." />
          ...
          {doing
              ? doing.map((el, index) => {
                  return (
                    <div key={index} onDragStart={(e) => heandleDragStart(e, el)} draggable className="list">
                      <p>{el.text}</p>
                      <div className="actions">
                        <svg
        ...
        <div droppable  onDrop={(e) => handleDrop(e, "done")} onDragOver={handleDragOver} className="done">
          <div className="default">
            <h3>DONE</h3>
            <div className="inp__btn">
              <input ref={doneRef} type="text" placeholder="Enter done work..." />
